...
exports.applications = {
    ...
    instances : {
        ...
        tabs : [{
            ...
            colorIndex  : 2,
            bomIcon     : 'icon-item',
            fieldsIn    : ['Supplier', 'Model', 'Serial #', 'Previous Serial #', 'M_nenn gearb.', 'n_nenn gearb.', 'Output acceleration','Power Supply', 'Installation Date', 'Location', 'Item Title', 'Item Rev', 'Instance #', 'Instance Path'],
            fieldsList  : {
                partNumber   : 'NUMBER',
                title        : 'ITEM_TITLE',
                revision     : 'ITEM_REV',
